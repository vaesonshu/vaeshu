...
async function send(sendInfo) {
  ...
  let info = await transporter.sendMail({
    from: '"认证邮件" <xxx@xxx>', // sender address
    to: sendInfo.email, // list of receivers
    subject: sendInfo.user !== '' ? `你好开发者，${sendInfo.user}! 松鼠技术社区注册码` : '松鼠技术社区注册码', // Subject line
    text: `您在松鼠技术社区中注册, 您的邀请码是${sendInfo.code}, 邀请码的过期时间：${sendInfo.expire}`, // plain text body
    html: `
